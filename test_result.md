...
agent_communication:
  ...
  - agent: "main"
    message: "Starting frontend testing per user request. Please test: 1) Login/Registration flow, 2) Dashboard with stats display, 3) AI Fitness Coach chatbot UI and interaction, 4) Profile page with goals and measurements, 5) Navigation between pages. Focus on the AI chatbot integration as it's newly fixed. Backend URL: https://supabase-connect-22.preview.emergentagent.com/api"
  - agent: "testing"
